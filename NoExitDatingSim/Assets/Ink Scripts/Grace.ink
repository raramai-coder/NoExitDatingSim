...
***Perhaps we can find a way to get over it, we might still be right for each regardless of that small fact.
->knot_getOverIt
...
**Given what I actually did being a pimp wouldn't have landed me here.
Where I came from I had no real chance. No real chance to get an education, get a job in one of those fancy offices, least of all build an empire. 
But I did that- I built an empire
...
==knot_trustedWithChildren
{knot_peopleForPeople: Oh, you think you're better than me? Why don't you tell the truth about your 'getting people for people'. {knot_fakeName: And don't try lying again, because I know exactly what you mean by 'getting people for people'} ->knot_extentofTrafficking}
...
{not knot_reallyWantToKnow: It seems, congratulations are in order then. Did you ever succeed before you died?}
...
==knot_speechless
I ...... am speechless. Why would you do such a pontless thing?
...
**Of course you would think so. If only I ever ran into you whene we were alive
